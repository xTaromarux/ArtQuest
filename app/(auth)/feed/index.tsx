...
import { Dimensions, KeyboardAvoidingView, Platform, View, FlatList, ActivityIndicator, Text, RefreshControl } from "react-native";
...
const ExerciseScreen: React.FC = () => {
  ...
  const user1: UserType = {
    ...
    login: "User1",
    name: "John Doe",
    avatar_url: "https://i.pinimg.com/736x/58/94/8d/58948d9dace5f470e60149bffbe17841.jpg",
  };
  ...
  const user2: UserType = {
    ...
    login: "User2",
    name: "Jane Smith",
    avatar_url: "https://i.pinimg.com/736x/75/9d/0c/759d0c791c0f36599ebe489fc9010c7d.jpg",
  };
  ...
  const tweets: TweetType[] = [
    { 
      ...
      image_url: "https://i.pinimg.com/736x/51/2e/df/512edf4a5517ef22e7bb34de6c8b2c4c.jpg",
      numberOfComments: 5,
      numberOfRetweets: 10,
      numberOfLikes: 20,
      impressions: 100,
    ...
    { 
      ...
      user: user2, 
      createdAt: new Date().toISOString(),
      image_url: "https://i.pinimg.com/736x/54/c5/88/54c588122b4e0ecf28badb5fd0b3012b.jpg",
      numberOfComments: 3,
      numberOfRetweets: 6,
      numberOfLikes: 15,
      impressions: 80,
